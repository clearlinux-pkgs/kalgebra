...
Source0  : https://download.kde.org/stable/release-service/25.04.0/src/kalgebra-25.04.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/25.04.0/src/kalgebra-25.04.0.tar.xz.sig
...
%setup -q -n kalgebra-25.04.0
cd %{_builddir}/kalgebra-25.04.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1744950692
mkdir -p clr-build
pushd clr-build
