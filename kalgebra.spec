...
Source0  : https://download.kde.org/stable/release-service/24.12.3/src/kalgebra-24.12.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.12.3/src/kalgebra-24.12.3.tar.xz.sig
...
%setup -q -n kalgebra-24.12.3
cd %{_builddir}/kalgebra-24.12.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742535626
mkdir -p clr-build
pushd clr-build
