...
Version  : 25.04.2
Release  : 43
URL      : https://download.kde.org/stable/release-service/25.04.2/src/kalgebra-25.04.2.tar.xz
Source0  : https://download.kde.org/stable/release-service/25.04.2/src/kalgebra-25.04.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/25.04.2/src/kalgebra-25.04.2.tar.xz.sig
...
%setup -q -n kalgebra-25.04.2
cd %{_builddir}/kalgebra-25.04.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1749530200
mkdir -p clr-build
pushd clr-build
