...
Version  : 19.12.0
Release  : 12
URL      : https://download.kde.org/stable/release-service/19.12.0/src/kalgebra-19.12.0.tar.xz
Source0  : https://download.kde.org/stable/release-service/19.12.0/src/kalgebra-19.12.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/19.12.0/src/kalgebra-19.12.0.tar.xz.sig
...
%prep
%setup -q -n kalgebra-19.12.0
cd %{_builddir}/kalgebra-19.12.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1576546515
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kalgebra-19.12.0/COPYING %{buildroot}/usr/share/package-licenses/kalgebra/4cc77b90af91e615a64ae04893fdffa7939db84c
cp %{_builddir}/kalgebra-19.12.0/COPYING.DOC %{buildroot}/usr/share/package-licenses/kalgebra/1bd373e4851a93027ba70064bd7dbdc6827147e1
cp %{_builddir}/kalgebra-19.12.0/COPYING.LIB %{buildroot}/usr/share/package-licenses/kalgebra/ba8966e2473a9969bdcab3dc82274c817cfd98a1
cp %{_builddir}/kalgebra-19.12.0/cmake/COPYING-CMAKE-SCRIPTS %{buildroot}/usr/share/package-licenses/kalgebra/ff3ed70db4739b3c6747c7f624fe2bad70802987
pushd clr-build
%make_install
popd
%find_lang kalgebra
