...
Source0  : https://download.kde.org/stable/release-service/24.05.0/src/kalgebra-24.05.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.05.0/src/kalgebra-24.05.0.tar.xz.sig
...
%setup -q -n kalgebra-24.05.0
cd %{_builddir}/kalgebra-24.05.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1716589742
mkdir -p clr-build
pushd clr-build
